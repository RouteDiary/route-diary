...
public interface NoticeRepository {
	 ...
	 */
//	public List<Notice> selectNotices(int startRow, int endRow) throws SelectException;
	/**
	 ...
	 * @return List<Notice> 공지사항리스트
	 */
	public List<Notice> selectNotices(@Param("startRow") int startRow, @Param("endRow")int endRow, @Param("keyword")@Nullable String keyword) throws SelectException;
