...
public class AdminServiceImpl implements AdminService {
  ...
  public void writeNotice(Notice notice ,List<MultipartFile> imgFiles) throws AddException {
    ...
    try {
      ...
      logger.info(absolutePath); ///Users/minseong/Desktop/semi-project/back/ -->운영체제마다 다른걸 file.sperator 로 맞춰줌.
      // 이미지 파일 저장 로직
      int imageNo = 0; // 생성자.
      String path = "images" + File.separator + "notice_images" + File.separator + "notice" + noticeNo;
...
//        String thumbnailName = absolutePath+ File.separator + 
      }      
