...
public interface ClientService {
   ...
   */
  void login(String clientId) throws FindException;
   ...
   */
  void removeAccount(Client client) throws UpdateException;
  /**
   ...
   * @throws FindException 
   */
  void idDuplicationCheck(String clientId) throws SelectException, FindException;
   ...
   * @throws SelectException
   */
  void NicknameDuplicationCheck(String clientNickname) throws SelectException, FindException;
