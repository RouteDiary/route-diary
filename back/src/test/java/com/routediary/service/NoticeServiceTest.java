...
class NoticeServiceTest {
  ...
  void testshowNoticeBoard() throws FindException {
    ...
    // PageBean<Notice> notice = noticeService.showNoticeBoardByKeyword(expectedcurrentPage1,
    // keyword1);
    // test1
  ...
  void testshowNoticeBoardByKeyword() throws FindException {
    ...
    // PageBean<Notice> notice = noticeService.showNoticeBoardByKeyword(expectedcurrentPage,
    // keyword);
    PageBean<Notice> notice =
        noticeService.showNoticeBoardByKeyword(expectedcurrentPage1, keyword1);
    // test1
    // assertNotNull(notice);
    // assertEquals(notice.getCntPerPageGroup(),expectedCntPerPageGroup);
    // assertEquals(notice.getCurrentPage(),expectedcurrentPage);
  ...
  @Test
  void testshowNotice() throws Exception {
