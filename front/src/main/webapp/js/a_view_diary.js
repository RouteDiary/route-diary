$(() => {
  ...
  // let diaryNo = 7;
  $.ajax({
    url: "http://localhost:9997/back/admin/diary/" + diaryNo,
    method: "GET",
    error: (jqXHR) => {
      alert(jqXHR.stauts);
    },
  ...
  $("div.comments").on("click", "div.comment_view>button.delete", (e) => {
    ...
    $.ajax({
      url: "http://localhost:9997/back/admin/diary/" + diaryNo + "/comment",
      method: "delete",
  ...
  $("div.diary_delete").on("click", "button.delete", (e) => {
    ...
    $.ajax({
      url: "http://localhost:9997/back/admin/diary/" + diaryNo /*diaryNo*/,
      method: "delete",
      contentType: "application/json",
